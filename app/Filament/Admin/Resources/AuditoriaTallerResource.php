...
use App\Filament\Admin\Resources\AuditoriaTallerResource\Pages\ListAuditoriaTalleres;
...
/**
 * Auditoría de cambios sensibles de TODOS los talleres (015-spec.md), sin el filtro por taller
 * activo de la variante `/erp`, escrita por `App\Observers\TallerObserver`. Solo lectura.
 */
class AuditoriaTallerResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Auditoría de Talleres';

    protected static ?string $modelLabel = 'Cambio Auditado';

    protected static ?string $slug = 'auditoria-talleres';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('taller.nombre')->label('Taller'),
            ...
            ->recordActions([
                ViewAction::make()->schema([
                    TextEntry::make('taller.nombre')->label('Taller'),
