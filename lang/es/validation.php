...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción al español de `lang/en/validation.php` (Laravel 12) — el framework no la trae
    | incluida por defecto, solo el inglés como último fallback interno. Sin este archivo, con
    | `APP_LOCALE=es`, cualquier mensaje de validación nativo (no sobreescrito por un FormRequest)
    | se vería en inglés o como la clave cruda.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute ingresado aparece en una filtración de datos conocida. Elige un :attribute diferente.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Vacío a propósito: los campos del proyecto ya usan nombres de columna en español
    | (`nombre`, `telefono`, `fecha_recepcion`...), así que el `:attribute` crudo ya se lee bien
    | sin necesidad de un mapeo adicional.
    |
    */
